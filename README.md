...
### 我沒有GG Boss（第一階段 HP: 100 / 第二階段「蔡徐坤」 姬姬長度: 2000km）

Boss「我沒有GG」第一階段為原地發射迪克小刀的戰渣，被擊敗後會進入第二階段變身為「蔡徐坤」，外觀由 4 張圖片由上往下循環切換（第四張播完回到第一張重新開始），血量顯示為「姬姬長度：2000km」，並會在第 3、4 張高速衝向玩家喊出「雞你太美」。
...
- **第二階段：蔡徐坤（姬姬長度: 2000km，第一階段血量歸零後觸發）**
  ...
  - **大絕招「中分頭爆炸」**（隨機 5~7 秒觸發）：
    - **最短路徑移動與空中鎖定蓄力**：蔡徐坤圖片切換為經典「中分頭」並放大 2 倍，以最短直線路徑快速飛至畫面正中心點後**完全定住在空中（關閉重力不往下掉）**，展開旋轉銀灰科技魔法陣、6 組逆向向心收縮震波環與 200 顆全螢幕匯聚能量光球，蓄力 **2.0 秒**（提供充足時間供玩家逃脫），頂部顯示預警標語，左右下角展開綠色光圈安全區。
    - **超究極華麗灰色主題大爆炸**：全螢幕爆發 8 層灰色同心衝擊波光環、24 道穿透全螢幕的銀灰/白金射線與 180+ 灰色金屬/煙塵碎屑粒子，伴隨全螢幕灰白閃光、核爆級劇烈震動與特大金色立體字幕「💥 蔡徐坤 · 中分頭究極大爆炸 💥」。
    - **無視盾牌致死判定**：爆炸**無視任何盾牌或衝刺無敵**！全螢幕判定致死，**只有緊貼螢幕左右下角安全區**的玩家才可成功避難存活。
  - **死於第二階段蔡徐坤之神秘問答**：
  ...
  - **通關結尾畫面（擊敗第二階段蔡徐坤）**：
    - 擊敗蔡徐坤後進入黑色背景畫面，展示推薦歌曲列表與 246 秒倒數計時：
      - 《雞勇者》
      - 《雞在叫，唱跳的人是我》
      - 《唱跳rap大男孩》
      - 提示標語：「確保你所有都聽完，倒數 246 秒」
    - 246 秒倒數結束後切換至最終畫面：上方顯示「一句話跟你說」，下方顯示特大字「雞你太美」，附帶重新挑戰按鈕。
  - **變身特效與血量**：觸發金色全螢幕閃光與鏡頭震動，血量文字切換為金色「姬姬長度：2000km」（傷害以純數值扣減）。
...
|----|------|
| 100（一階段） | 原地發射迪克小刀 |
| ≤ 0（一階段） | 觸發變身，進入第二階段「蔡徐坤」（姬姬長度: 2000km） |
| ≤ 0（二階段） | 蔡徐坤被擊敗 → 進入黑色背景推薦歌曲與「雞你太美」通關結尾畫面 |
